...
/*
   ...
   On utilise plusieurs couleurs
   pour avoir une rotation plus jolie.
*/
    ...
    async () => {
        ...
        try {
            ...
            if (!rgbRole) {
                ...
                console.error(
                    "❌ Rôle RGB introuvable !"
                );

            } else {

                console.log(
                    `🌈 RGB activé sur le rôle : ${rgbRole.name}`
                );
                ...
                console.log(
                    `🌈 Couleur RGB : ${RGB_COLORS[rgbColorIndex]}`
                );
                ...
                setInterval(
                    async () => {
                        ...
                        try {
                            ...
                            console.error(
                                "❌ Impossible de changer la couleur du rôle :",
                                error.message
                            );
